...
Buscamos verificar quanto tempo os entrevistados gastam nas redes sociais e tiramos a média desse tempo, para ter noção do quanto as pessoas se familiarizam com essas tecnologias.
...
##Relações entre as respostas

Tentamos relacionar as respostas para tomarmos algumas conclusões sobre a pesquisa.
```{r echo=FALSE, fig.align="center", out.width="1000px"}
library(readxl)
df <- read_excel("../dados/umses_alunos_2018.xlsx")
...
##Relação aluno-professor com uso das redes sociais

```{r echo=F, fig.align="center", out.width="1000px"}
...
##Dificuldades no uso de mídias sociais na educação
